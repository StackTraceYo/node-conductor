...
import 'mocha';
import {Job, JobListener, JobResult} from '../job/Job';
import {Dispatcher, JobStatus} from './Dispatcher';
...
describe('Dispatcher', () => {
    ...
    it('should be schedule and run a job with custom listener', () => {
        ...
        let listener: JobListener = {
            onJobStarted: (result: JobResult) => console.log("Started in Custom Listener"),
            onJobRunning: (result: JobResult) => console.log("Running in Custom Listener"),
            onJobCompleted: (result: JobResult) => console.log("Complete in Custom Listener"),
        };
